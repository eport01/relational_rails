  ...
  describe 'as a visitor' do 
    describe 'when I visit /apartments/:apartment_id/tenants' do 
      before :each do 
        ...
        @apartment_2 = Apartment.create!(apt_name: "Dog House", has_wd: true, unit_count: 100, 
          city: "Denver", state: "CO", pet_friendly: true
        )
      ...
      it 'I see each tenant in that apartment and their attributes' do 
        ...
        expect(page).to_not have_content(@tenant_4.tenant_name)
      ...
      it 'the tenants of an apartment can be sorted in alphabetical order by name' do 
        ...
        expect(@tenant_2.tenant_name).to appear_before(@tenant_1.tenant_name)
      ...
      it 'i can click on a link to delete tenant and return to index page where tenant is not listed' do 
        ...
        expect(page).to_not have_content("#{@tenant_2.tenant_name}")
